          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="space-y-3">
              ...
              <div className="rounded-md border border-border overflow-hidden">
                <button
                  className="w-full flex items-center justify-between bg-muted/30 px-4 py-2.5 text-left"
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                          ...
                          <div className="md:col-span-1 p-4 bg-card/50 rounded-lg border border-border/50">
                            ...
                            >
                              ...
                              <span>
                                {showCompare ? 'Disable Comparison' : 'Enable Comparison'}
                              </span>
              ...
              <div className="flex flex-col gap-2 relative">
                ...
                <AnimatePresence>
                  {showCompare && (
                    <motion.div
                      className={`fixed inset-x-0 ${selectedSkip ? 'bottom-30' : 'bottom-0'} md:bottom-auto md:right-4 md:top-52 md:left-auto md:w-80 z-[100]`}
                            ...
                            <Drawer>
                              ...
                              <DrawerContent className="max-h-[85dvh]">
                                <DrawerHeader>
                                  ...
                                  <DrawerDescription>
                                    Compare up to three skips side by side to find the best option
                                    for your needs.
                                  </DrawerDescription>
                                </DrawerHeader>
              ...
              {/* Empty placeholder for the original comparison UI that we're replacing */}
            ...
            <div className="flex justify-end border-t border-border pt-3 mt-2">
              <button
                onClick={resetFilters}
                className="px-3 py-1.5 text-xs font-medium text-primary hover:text-primary/80 hover:bg-primary/10 rounded-md transition-colors flex items-center gap-1.5"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="12"
